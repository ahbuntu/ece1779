...
public class Worker extends Thread {
	...
	public Worker(LoadGenerator generator, int id) {
	...
	public void run() {
	 ...
	 private void postFile(String filename) {
	        ...
	        try {
	            ...
	            message1 += "Content-Disposition: form-data; name=\"uploadedfile\"; filename=\"test.gif\""
	                    + CrLf;
	            ...
	            conn.setRequestProperty("Content-Length", String.valueOf((message0.length() +
	            		message1.length() + message2.length() + imgData.length)));
